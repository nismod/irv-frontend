    ...
    resources: [
      {
        ...
        description: '',
        access_url: 'https://ora.ox.ac.uk/objects/uuid:8d95c423-816c-4a4f-88b6-eb7a040cb40e',
      },
    ],
    lineage: {
      ...
      sources: [
        {
          id: 'source_cooling_degree_days',
          name: 'Miranda, N.D., Lizana, J., Sparrow, S.N. et al. (2023) Change in cooling degree days with global mean temperature rise increasing from 1.5C to 2.0C. Nature Sustainability 6, 1326-1330. DOI https://doi.org/10.1038/s41893-023-01155-z',
