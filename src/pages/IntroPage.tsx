...
export const IntroPage = () => {
  return (
    <>
      <ArticleContainer>
        <HeaderBlock>
          <HeadingBoxText>Risk Analytics</HeadingBoxText>
          <HeadingBoxText>Global Climate-Related</HeadingBoxText>
        </HeaderBlock>

        {/* <div className="home" style={{ height: '16rem' }}></div>
         */}

        <BannerImage imageUrl="/irma-2017_data-from-nasa-modis_processed-by-antti-lipponen_1280.jpg" />
        ...
        <ArticleContentContainer>
          ...
          <ArticleSection>
            ...
            <ArticleParagraph>
              ...
              the UK Centre for Greening Finance and Investment, the World Bank Group, Insurance for
              Development Forum, and the UK Foreign Commonwealth and Development Office (FCDO)
              through the Climate Compatible Growth (CCG) programme.
            </ArticleParagraph>
          ...
          <ArticleSection>
            ...
            <ArticleParagraph>
              ...
              that may subsequently arise from use of the data or this tool for any purpose. Please
              consult our <Link to="/terms-of-use">website terms of use</Link> for more information
