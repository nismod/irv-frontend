    ...
    <div className="centred">
      ...
      <ul>
        <li>
          ...
          data we collect from you, or that you provide to us. By using our site, you consent to
          such processing.
        </li>
      ...
      <p>
        ...
        parties, by those third parties. The copyright in the material contained on our site belongs
        to us or our licensors. It is your responsibility to seek appropriate consent to re-use any
      ...
      <p>
        ...
        information and these materials have not been verified or approved by us. The views
      ...
      <p>
        ...
        disputes or claims) are governed by English law. We both agree to the exclusive jurisdiction
      ...
      <p>
        ...
        documents referred to in it, describes how we collect and use your personal data during your
        use of our site, in accordance with the General Data Protection Regulation (GDPR) and
      ...
      <p>
        Access to your personal data within the University will be provided to those staff who need
        to view it as part of their work in connection with the operation of this website.
      </p>
      ...
      <p>
        ...
        the Internet protocol (IP) address used to connect your device to the Internet, browser type
      ...
      <ul>
        <li>
          ...
          processing occurs because it is necessary to meet our legitimate interests in operating
          this website. Information processed for this purpose includes, but is not limited to IP
          address, URL, request headers and date and time of HTTP/S requests
        </li>
      </ul>

      <p>
        We will only use your data for the purposes for which we collected it, unless we reasonably
        consider that we need to use it for another related reason and that reason is compatible
        with the original purpose. If we need to use your data for an unrelated purpose, we will
        seek your consent to use it for that new purpose.{' '}
      </p>
      ...
      <ul>
        <li>
          ...
          you to receive a copy of your data and to check that we are lawfully processing it.
        </li>
        ...
        <li>
          ...
          where there is no good reason for us continuing to process it. You also have the right to
          ask us to delete or remove your data where you have exercised your right to object to
      ...
      <p>
        Depending on the circumstances and the nature of your request it may not be possible for us
        to do what you have asked, for example, where there is a statutory or contractual
      ...
      <p>
        ...
        email address may be used to contact the University's Data Protection Officer. We will seek
        to deal with your request without undue delay, and in any event in accordance with the
        requirements of the GDPR. Please note that we may keep a record of your communications to
      ...
      <p>
        ...
        the contact email address given above or by post at University of Oxford, University
      ...
      <p>
        This statement explains how we use cookies on the website. For information about what types
        of personal information will be gathered when you visit the website, and how this
      ...
      <p>
        ...
        you from other users of our website, which helps us to provide you with a good experience
        when you browse our website and enables us to improve our website.
      </p>
      ...
      <p>
        ...
        use a website, for instance which pages visitors go to most often. We use this information
        to improve our websites and to aid us in investigating problems raised by visitors. These
